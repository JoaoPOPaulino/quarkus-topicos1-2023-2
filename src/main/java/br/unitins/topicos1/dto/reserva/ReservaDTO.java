...
public record ReservaDTO(
                ...
                @FutureOrPresent(message = "A data do final da reserva deve ser igual ou posterior à data atual") @NotNull(message = "A data de fim não pode ser nula.") LocalDate dataF,
